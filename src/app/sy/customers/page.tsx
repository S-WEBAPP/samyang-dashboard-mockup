...
import { CustomersFilters } from '@/components/sy/customer/customers-filters';
import { CustomersTable } from '@/components/sy/customer/customers-table';
import type { Customer } from '@/components/sy/customer/customers-table';
